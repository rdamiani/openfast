 ...
 ! buffers to store subtypes, if any
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i2 = LBOUND(InData%MBBnoSSI,2), UBOUND(InData%MBBnoSSI,2)
        DO i1 = LBOUND(InData%MBBnoSSI,1), UBOUND(InData%MBBnoSSI,1)
          ReKiBuf(Re_Xferred) = InData%MBBnoSSI(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i2 = LBOUND(InData%MBBb,2), UBOUND(InData%MBBb,2)
        DO i1 = LBOUND(InData%MBBb,1), UBOUND(InData%MBBb,1)
          ReKiBuf(Re_Xferred) = InData%MBBb(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i2 = LBOUND(InData%MBMb,2), UBOUND(InData%MBMb,2)
        DO i1 = LBOUND(InData%MBMb,1), UBOUND(InData%MBMb,1)
          ReKiBuf(Re_Xferred) = InData%MBMb(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i2 = LBOUND(InData%KBBb,2), UBOUND(InData%KBBb,2)
        DO i1 = LBOUND(InData%KBBb,1), UBOUND(InData%KBBb,1)
          ReKiBuf(Re_Xferred) = InData%KBBb(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i2 = LBOUND(InData%PhiRb,2), UBOUND(InData%PhiRb,2)
        DO i1 = LBOUND(InData%PhiRb,1), UBOUND(InData%PhiRb,1)
          ReKiBuf(Re_Xferred) = InData%PhiRb(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i2 = LBOUND(InData%PhiRnoSSI,2), UBOUND(InData%PhiRnoSSI,2)
        DO i1 = LBOUND(InData%PhiRnoSSI,1), UBOUND(InData%PhiRnoSSI,1)
          ReKiBuf(Re_Xferred) = InData%PhiRnoSSI(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
 ...
 ! buffers to store meshes, if any
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i2 = LBOUND(OutData%MBBnoSSI,2), UBOUND(OutData%MBBnoSSI,2)
        DO i1 = LBOUND(OutData%MBBnoSSI,1), UBOUND(OutData%MBBnoSSI,1)
          OutData%MBBnoSSI(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i2 = LBOUND(OutData%MBBb,2), UBOUND(OutData%MBBb,2)
        DO i1 = LBOUND(OutData%MBBb,1), UBOUND(OutData%MBBb,1)
          OutData%MBBb(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i2 = LBOUND(OutData%MBMb,2), UBOUND(OutData%MBMb,2)
        DO i1 = LBOUND(OutData%MBMb,1), UBOUND(OutData%MBMb,1)
          OutData%MBMb(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i2 = LBOUND(OutData%KBBb,2), UBOUND(OutData%KBBb,2)
        DO i1 = LBOUND(OutData%KBBb,1), UBOUND(OutData%KBBb,1)
          OutData%KBBb(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i2 = LBOUND(OutData%PhiRb,2), UBOUND(OutData%PhiRb,2)
        DO i1 = LBOUND(OutData%PhiRb,1), UBOUND(OutData%PhiRb,1)
          OutData%PhiRb(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i2 = LBOUND(OutData%PhiRnoSSI,2), UBOUND(OutData%PhiRnoSSI,2)
        DO i1 = LBOUND(OutData%PhiRnoSSI,1), UBOUND(OutData%PhiRnoSSI,1)
          OutData%PhiRnoSSI(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
 ...
 ! buffers to store subtypes, if any
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i2 = LBOUND(InData%Korig,2), UBOUND(InData%Korig,2)
        DO i1 = LBOUND(InData%Korig,1), UBOUND(InData%Korig,1)
          ReKiBuf(Re_Xferred) = InData%Korig(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i2 = LBOUND(InData%KorignoSSI,2), UBOUND(InData%KorignoSSI,2)
        DO i1 = LBOUND(InData%KorignoSSI,1), UBOUND(InData%KorignoSSI,1)
          ReKiBuf(Re_Xferred) = InData%KorignoSSI(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i2 = LBOUND(InData%Morig,2), UBOUND(InData%Morig,2)
        DO i1 = LBOUND(InData%Morig,1), UBOUND(InData%Morig,1)
          ReKiBuf(Re_Xferred) = InData%Morig(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i2 = LBOUND(InData%MorignoSSI,2), UBOUND(InData%MorignoSSI,2)
        DO i1 = LBOUND(InData%MorignoSSI,1), UBOUND(InData%MorignoSSI,1)
          ReKiBuf(Re_Xferred) = InData%MorignoSSI(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
 ...
 ! buffers to store meshes, if any
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i2 = LBOUND(OutData%Korig,2), UBOUND(OutData%Korig,2)
        DO i1 = LBOUND(OutData%Korig,1), UBOUND(OutData%Korig,1)
          OutData%Korig(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i2 = LBOUND(OutData%KorignoSSI,2), UBOUND(OutData%KorignoSSI,2)
        DO i1 = LBOUND(OutData%KorignoSSI,1), UBOUND(OutData%KorignoSSI,1)
          OutData%KorignoSSI(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i2 = LBOUND(OutData%Morig,2), UBOUND(OutData%Morig,2)
        DO i1 = LBOUND(OutData%Morig,1), UBOUND(OutData%Morig,1)
          OutData%Morig(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i2 = LBOUND(OutData%MorignoSSI,2), UBOUND(OutData%MorignoSSI,2)
        DO i1 = LBOUND(OutData%MorignoSSI,1), UBOUND(OutData%MorignoSSI,1)
          OutData%MorignoSSI(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  END IF
    ...
    Int_Xferred = Int_Xferred + 1
    IntKiBuf(Int_Xferred) = InData%DofCk
    Int_Xferred = Int_Xferred + 1
    IntKiBuf(Int_Xferred) = InData%DofCr
    Int_Xferred = Int_Xferred + 1
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i1 = LBOUND(InData%IDCK,1), UBOUND(InData%IDCK,1)
        IntKiBuf(Int_Xferred) = InData%IDCK(i1)
        Int_Xferred = Int_Xferred + 1
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i1 = LBOUND(InData%IDCR,1), UBOUND(InData%IDCR,1)
        IntKiBuf(Int_Xferred) = InData%IDCR(i1)
        Int_Xferred = Int_Xferred + 1
      END DO
  END IF
 ...
 ! buffers to store meshes, if any
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i1 = LBOUND(OutData%IDCK,1), UBOUND(OutData%IDCK,1)
        OutData%IDCK(i1) = IntKiBuf(Int_Xferred)
        Int_Xferred = Int_Xferred + 1
      END DO
  END IF
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i1 = LBOUND(OutData%IDCR,1), UBOUND(OutData%IDCR,1)
        OutData%IDCR(i1) = IntKiBuf(Int_Xferred)
        Int_Xferred = Int_Xferred + 1
      END DO
  END IF
